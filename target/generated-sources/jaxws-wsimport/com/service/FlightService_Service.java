 ...
 * 
 */
@WebServiceClient(name = "FlightService", targetNamespace = "http://service.com/", wsdlLocation = "http://localhost:8080/flightApp/FlightService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FLIGHTSERVICE_QNAME = new QName("http://service.com/", "FlightService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/flightApp/FlightService?wsdl");
    ...
    public FlightService getFlightServicePort() {
        return super.getPort(new QName("http://service.com/", "FlightServicePort"), FlightService.class);
    }
    ...
    public FlightService getFlightServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "FlightServicePort"), FlightService.class, features);
    }
